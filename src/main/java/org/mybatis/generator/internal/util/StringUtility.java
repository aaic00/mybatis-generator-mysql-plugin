...
public class StringUtility {
  ...
  public static String composeFullyQualifiedTableName(final String catalog, final String schema,
      final String tableName, final char separator) {
  ...
  public static String escapeStringForJava(final String s) {
    final StringTokenizer st = new StringTokenizer(s, "\"", true); //$NON-NLS-1$
    final StringBuilder sb = new StringBuilder();
